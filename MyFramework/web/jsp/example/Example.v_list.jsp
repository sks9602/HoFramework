...
%><%-- @ taglib prefix="pjt"  tagdir="/WEB-INF/tags/pjt" 
--%>
	...
	<jun:data>
		...
		<jun:data>
			<jun:grid id="grid_1" action="/example/example.do" button="저장" page="5" fields="Sample.selectTableList" groupTpl="" groupName="" listeners="cellclick:fs_v_list_cellclick" editable="Y"> <!--  lead="checkbox"  -->
				<jun:toolbars>
					<jun:toolbarDetail  type="combotipple_ux" title="타이틀" >
						<jun:columnCode  type="combo" name="TYPE" groupCode="SYS001" width="150"> 
						</jun:columnCode>				
					</jun:toolbarDetail>
					<jun:toolbarDetail  type="button"  title="타이틀" >
					</jun:toolbarDetail>
				</jun:toolbars>
				<jun:columns>
